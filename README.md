...
![Logo](./src/img/logo0-20190704.png "logo")

[![Status](https://img.shields.io/badge/status-active-success.svg)](http://#)
...
The following features might not be ready at the beginning of development, but
are nevertheless helpful for users.

### Badges

[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-v1.4%20adopted-ff69b4.svg)](code-of-conduct.md)

Badges can be included here if you don't want them listed in the heading under a
logo graphic.
...
* ~~Consider adding logo/badges/etc. above the title~~
  * ~~Remove description heading~~ - Decided to keep
